...
const showDashboard = async (req, res) => {
  ...
  res.render('user/userViews', { user, title: 'biblitecgam | user' });
};
...
const login = (req, res) => {
  ...
  res.render('user/login', { title: 'Bibliotecgam | Login' });
};
...
const register = (req, res) => {
  ...
  res.render('user/register', { title: 'bibliotecgam | Register' });
};
